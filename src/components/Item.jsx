...
class Item extends Component  {
    ...
    componentDidMount(){
        ...
        this.rating.addEventListener('click', ()=>{
                axios.post('http://suvorovs88.ho.ua/testEpicenter/handler.php', {type : 'ratingVote', user_vote : user_votes, item_id : 1})
    ...
    addToCard(){
        axios.post('http://suvorovs88.ho.ua/testEpicenter/handler.php', {type : 'addToCard', order : {
